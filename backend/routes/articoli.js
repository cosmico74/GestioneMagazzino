...
router.post('/:id/sigle', verifyToken, async (req, res) => {
  ...
  try {
    ...
    // Audit per la sigla creata/riattivata
...
// ============================================================
// PUT /sigle/:id - MODIFICA GENERICA (con AUDIT)
// ============================================================
...
// ============================================================
// PUT /sigle/:id/austria - MODIFICA QUANTITA' AUSTRIA (con AUDIT)
// ============================================================
