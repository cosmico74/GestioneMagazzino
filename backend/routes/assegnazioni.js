...
// ============================================================
// OTTIENI OGGETTI IN CARICO (con filtro settore)
// ============================================================
...
// ============================================================
// GET /api/assegnazioni/oggetti/tutti - Tutti gli oggetti in carico ai soggetti visibili
// ============================================================
router.get('/oggetti/tutti', verifyToken, async (req, res) => {
  try {
    ...
    // 3. Formatta i risultati (come in /oggetti)
    const risultati = [];
    for (const row of rows) {
      let sigleDisponibili = [];
      if (row.tipo_oggetto === 'ARTICOLO') {
